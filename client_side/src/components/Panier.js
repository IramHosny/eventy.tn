                ...
                <div className='userscontainer'>
                    ...
                    <div className='userslist'>
                        {cart.cartItems.length === 0 ? (
                            <h4 style={{ textAlign: 'center' }}>Votre panier est vide ! <Link to={"/prestataires"}>commander maintenant </Link> </h4>
                        ) : (
                            <>
                                <table>
                                    <tbody>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'right' }}>
                                    <span style={{ float: 'right', color: 'red', fontWeight: 'bold' }}>Total: {(cart.cartTotalAmount).toFixed(2)} DT</span>
